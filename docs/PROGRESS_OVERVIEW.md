# Wire Rush — 프로토타입 0.5.2

2026-09-14. 먼 지점 조준을 사거리 내 실제 표면으로 보정하고, 연결된 장애물 뒤쪽으로 스윙할 때 줄이 끊기는 문제를 수정했습니다. 해제 당시 플레이어 높이 5m 착지 기준을 유지합니다.

## 실행

- 프로젝트: `D:/GameProject/WireSwing/project.godot`
- 실행 파일: `builds/WireRush-0.5.2-Windows/WireRush.exe`
- 배포 ZIP: `builds/WireRush-0.5.2-Windows.zip`
- 저장소: https://github.com/Autopopcornshooter/wire-rush

기존 HellDelivery와 별도의 프로젝트입니다. 엔진·템플릿·빌드는 Git에서 제외하며 이전 0.1.0~0.5.1 로컬 빌드는 보존합니다.
...
- 소스 렌더링 fixture: 먼 벽·공중 장애물 조준의 보정 표식, 장애물 뒤쪽 연결 유지 화면 확인.
- EXE SHA256: `01116AC86DE59A10A62A0126ED6C26E5DD9720F33ABEF41E2CD96990DCACD862`.
