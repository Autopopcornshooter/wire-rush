...
$buildDir = Join-Path $projectRoot 'builds\WireSwing-0.1.0-Windows'
...
Compress-Archive -LiteralPath $outputPath,(Join-Path $buildDir 'PLAY_GUIDE.md'),(Join-Path $buildDir 'THIRD_PARTY_NOTICES.md') -DestinationPath (Join-Path $projectRoot 'builds\WireRush-0.1.0-Windows.zip') -Force
