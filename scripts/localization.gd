...
const KO: Dictionary = {
 ...
 "SKATING — speed held; Space to jump / mouse to reconnect": "스케이트 — 속도 유지 중 / Space 점프 / 마우스 재연결",
 "LANDED — stopped safely; Space to jump or mouse to hook": "안전 착지 — 정지 / Space 점프 또는 마우스로 연결하세요",
 "RESUME SHIELD — protected for 2 seconds": "복귀 보호 — 2초간 무적",
 "NEED TWO ANCHORS": "양쪽 앵커 필요",
 "LAND TO SKATE": "착지하면 스케이트로 속도 유지",
 "LAND TO STOP — Space to jump again": "착지하면 정지 — Space로 다시 점프",
 "SHIELD  /  %.1f s": "무적 보호  /  %.1f초",
 "SKATE  /  %.1f s LEFT": "스케이트  /  남은 시간 %.1f초",
 "LAUNCH": "사출 중",
 ...
 "Hold to reel automatically. Release the active button to let go.": "버튼 유지로 자동 줄 감기, 누르고 있는 버튼을 놓으면 해제",
 ...
 "SPEED": "속도",
 "GROUND": "지상 정지", "AIR": "공중", "SWING": "스윙", "SLIDE": "스케이트", "DEAD": "종료",
 ...
 "HARD LANDING — HOOK HIGHER": "낙하 충격 위험 — 더 높은 곳에 연결하세요",
 "SLIDE  /  %02d m LEFT": "슬라이드  /  남은 거리 %02d m",
 "HOLD LMB / RMB  hook + reel     SPACE  jump     A / D  steer     E  twin launch     ESC  pause     R  restart": "좌·우 클릭 유지  연결 + 자동 줄 감기     SPACE  점프     A / D  좌우 이동     E  양측 사출     ESC  일시정지     R  재시작",
 ...
 "HOLD LMB / RMB — automatic reeling while held": "좌·우 마우스 버튼 유지 — 자동으로 줄을 감으며 스윙합니다",
 ...
 "HOOK FIRED — hold to swing and reel": "갈고리 발사 — 버튼을 유지하면 스윙과 줄 감기를 함께 합니다",
